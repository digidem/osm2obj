  ...
  switch (name) {
    case 'tag':
      if (!attr.k || attr.v == null) {
        ...
        if (attr.k === '__mapeo_type') {
          // if there is a special mapeo type, such as 'observation', that is
          // being rendered in osm differently, convert that type back for
          // mapeo's purposes.
          currentNode.type = attr.v
        } else {
