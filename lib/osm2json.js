...
function Osm2Json (opts) {
  ...
  this.parser = new Parser(parserOpts)
...
Osm2Json.prototype.onOpenTag = function (name, attributes) {
  ...
  if (name === 'bounds') this.onCloseTag(name)
}
...
Osm2Json.prototype.processNode = function (name, attributes) {
  this.currentNode = {}
...
Osm2Json.prototype.processChild = function (name, attributes) {
